...
class Expt8RealtimeTests(unittest.TestCase):
    ...
    def test_record_trigger_only_emits_on_transition(self):
        self.assertTrue(expt8.should_record_point(4, 0))
        self.assertFalse(expt8.should_record_point(4, 4))
        self.assertFalse(expt8.should_record_point(0, 4))
